...
line-height: 59px">
                ...
                <div class="uk-grid">
                    ...
                    <form class="uk-form uk-width-medium-1-3" style="padding-left: 50px; margin-bottom: 20px" method="post" action="loginuser.php">
                        <fieldset>
                            ...
                            <div class="uk-form-row">
                                <div class="uk-grid">
                                    ...
                                    <div class="uk-button-group">
                                        <button style="width: 60px" class="uk-button uk-button-primary" name="login" >Login</button>
                                        <button style="width: 60px" class="uk-button" href="register.php"><a href="register.php">Register</a></button>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
